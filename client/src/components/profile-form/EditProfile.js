...
const EditProfile = ({
    ...
    // functions to update the social input states
    // displaySocialInputs is the current state 
    // toggleSocialInputs is the function to update the current state
    // the parameter passed in the useState() function is initialState
    const [displaySocialInputs, toggleSocialInputs] = useState(false);

    // run when the page got loaded
    // only activated when the loading is true
    useEffect(() => {
        getCurrentProfile();
